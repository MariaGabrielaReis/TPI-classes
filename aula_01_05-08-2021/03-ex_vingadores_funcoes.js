...
// Comparação entre personagens (com funções e laço de repetição)
const comparacao = (atributo1, atributo2) => {
...
const resultadoComparacao = (personagem1, personagem2) => {
    ...
    comparacao(personagem1.forca, personagem2.forca) ?
        (personagem1Pontuacao += 1) :
        (personagem2Pontuacao += 1);

    comparacao(personagem1.velocidade, personagem2.velocidade) ?
        (personagem1Pontuacao += 1) :
        (personagem2Pontuacao += 1);

    comparacao(personagem1.resistencia, personagem2.resistencia) ?
        (personagem1Pontuacao += 1) :
        (personagem2Pontuacao += 1);
